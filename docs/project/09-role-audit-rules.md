...
device_manager 设备管理员，设备与摄像头台账维护
...
| 操作 | 超管/院长 | 护士 | 设备管理员 | 康复师 | 家属 | 访客 |
|---|---|---|---|---|---|---|
| 老人档案 | 全部新增编辑 | 授权老人护理摘要 | 禁止 | 授权老人康复摘要 | 绑定摘要只读 | 禁止 |
| 护理任务 | 全部管理 | 授权老人管理 | 禁止 | 禁止 | 禁止 | 禁止 |
| 康复任务/计划 | 全部管理 | 授权摘要只读 | 禁止 | 授权老人管理 | 绑定摘要只读 | 禁止 |
| 设备台账 | 全部查看和维护 | 只读 | 查看、心跳与维护 | 禁止 | 禁止 | 禁止 |
| 摄像头 | 超管看原始配置，院长看脱敏台账 | 脱敏台账/本机测试 | 脱敏读取、新增和编辑；原地址不回显 | 禁止 | 禁止 | 禁止 |
| 设备事件接入 | 仅管理员 | 禁止 | 禁止 | 禁止 | 禁止 | 禁止 |
| AI 事件/告警 | 全部复核处置 | 授权事件复核处置 | 禁止 | 禁止 | 禁止 | 禁止 |
| 审计日志 | 可查看 | 禁止 | 禁止 | 禁止 | 禁止 | 禁止 |
