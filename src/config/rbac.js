(function initRBAC(global) {
  ...
  const routeRegistry = [
    ...
    },
    {
      ...
      legacyView: "safety",
      permission: PERMISSIONS.safetyView,
      permissions: [PERMISSIONS.safetyView],
      menuKey: "safety-alerts",
      label: "安全告警",
      icon: "shield-alert",
      breadcrumb: ["工作台", "安全告警"],
      pageMode: "live",
      moduleType: "safety-alerts",
    ...
    },
    {
      ...
      title: "告警记录",
      component: "AlertCenterPage",
      legacyView: "alert-records",
      permission: PERMISSIONS.alertView,
      permissions: [PERMISSIONS.alertView],
      menuKey: "alert-records",
      label: "告警记录",
      icon: "siren",
      breadcrumb: ["工作台", "告警记录"],
      pageMode: "history",
      moduleType: "alert-records",
      defaultTab: "history",
      isMenuVisible: true
    },
    {
